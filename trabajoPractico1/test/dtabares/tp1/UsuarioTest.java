...
public class UsuarioTest {
    ...
    public void laPosicionDelUsuarioDebeSerLatitudDiezYLongitudVeinte(){
        ...
        Usuario usuario = new Usuario(1000,200,20,TipoDeAtraccion.Aventura,posicionActual,new Posicion(0,0),1);
    ...
    public void elTipoDeAtraccionFavoritaDebeSerDelTipoDegustación(){
        ...
        Usuario usuario = new Usuario(1000,200,20,TipoDeAtraccion.Degustacion,posicionActual,new Posicion(0,0),1);
