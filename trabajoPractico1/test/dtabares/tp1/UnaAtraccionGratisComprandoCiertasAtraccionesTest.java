...
public class UnaAtraccionGratisComprandoCiertasAtraccionesTest {
    ...
    public void siNoCompraTodasLasAtraccionesQueSonParteDeLaPromocionLaReduccionDeCostoTotalDebeSerCero() {
        ...
        UnaAtraccionGratisComprandoCiertasAtracciones promo = new UnaAtraccionGratisComprandoCiertasAtracciones("Promo", periodoDeVigencia,setDeAtracciones,new Atraccion("Ravenhill", 10, 10, 50, TipoDeAtraccion.Degustacion, new Posicion(35, 42)));
    ...
    public void siElTuristaVisitara3AtraccionesDeLasCuales1DeCosto300EsGratisElDescuentoDebeSerDe300() {
        ...
        setDeAtracciones.add(new Atraccion("Rivendell", 500, 120, 90, TipoDeAtraccion.Paisaje, new Posicion(500, 10)));
        UnaAtraccionGratisComprandoCiertasAtracciones promo = new UnaAtraccionGratisComprandoCiertasAtracciones("Promo", periodoDeVigencia,setDeAtracciones,new Atraccion("Rivendell", 500, 120, 90, TipoDeAtraccion.Paisaje, new Posicion(500, 10)));
